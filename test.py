...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    if img_path != None:
        ...
        cv2.namedWindow("img_only", cv2.WINDOW_AUTOSIZE) ## creating a free windown to show the result
    ...
    ### --------------- for detection on video --------------------
        ...
        cv2.namedWindow("vid_out", cv2.WINDOW_AUTOSIZE)
        while True:
...
main(img_path="./test_images/Cars116.jpg") ## for image
